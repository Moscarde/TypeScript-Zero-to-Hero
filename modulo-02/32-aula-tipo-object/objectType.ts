...
console.log(onboarding01({ nome: 'Gabriel Moscarde' }));
...
console.log(onboarding02({ nome: 'Gabriel Moscarde', funcao: 'Vendedor' }));
...
console.log(onboarding03({ nome: 'Gabriel Moscarde', funcao: 'Vendedor', linguagem: 'JavaScript/Typescript' }));
